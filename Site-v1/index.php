...
<html lang="pt-br">
    <head>
        ...
        <title>Home - Imagine Games</title>
        ...
        <div class="container">            
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <p style="text-align: justify;">
                                A empresa Web Program nasceu no ano de 2023 com foco no desenvolvimento de jogos e atuando no desenvolvimento de sistemas, desenvolvimento gráfico, layout, identidade visual e desenvolvimento de aplicativo mobile. <br><br>


                                A Web Program nasceu da iniciativa de quatro amigos, jovens, estudantes do curso de Ciência da Computação da Universidade Nove de Julho(UNINOVE) e a junção dos conhecimentos obtidos no decorrer do curso permitiu o desenvolvimento dos mais diversos jogos e sistemas.<br>
            ...
            <div class="row row-cols-1 row-cols-md-3">
                <div class="col mb-4">
                    ...
                    <img src="img/promo_game.jpg" class="card-img-top" alt="..." height="220">
                    <div class="card-body">
                        <h5 class="card-title">Criação de Jogos</h5>
                        <p class="card-text">Foco no Desenvolvimento de jogos para desktop, consoles e dispositivos movéis. Baixe e divirta-se<br><br>
                        </p>
                        <a href="service.php">
                ...
                <div class="col mb-4">
                    <div class="card h-100">
                    <img src="img/app-desenv.jpg" class="card-img-top" alt="..." height="220">
                    <div class="card-body">
                ...
                <div class="col mb-4">
                    <div class="card h-100">
                    <img src="img/integracao.jpg" class="card-img-top" alt="..." height="220">
                    <div class="card-body">
